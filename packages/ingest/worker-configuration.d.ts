/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 54920c3a439cda706dc121df2966590c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CGA_WORKFLOW: Workflow<
			Parameters<import("./src/worker").CGAIngestWorkflow["run"]>[0]["payload"]
		>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<
				Cloudflare.Env,
				"CGA_BASE_URL" | "CGA_START_PATH" | "USC_DOWNLOAD_BASE"
			>
		> {}
}
